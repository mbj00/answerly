...
<body>
    ...
    <div class="card m-1">
        <div class="card-header">
            <h4 class="text-center">Browse all the topics</h4>
        </div>
        <div class="card-body">
            <div class="">
                <?php
        ...
        <!-- <div class="alert alert-primary m-2 question" role="alert">
            <div>
                <div>Hello, Should I die today or tomorrow</div>
                <div>
                    <p>Category :</p>
                    <p>By : </p>
                    <p>At:</p>
            ...
            <div class="answerForm">
                <form action="server/requests.php" method="post">
                    <button type="button" class="btn btn-info" name="demo">View</button>
                </form>
            </div>
        </div> -->
    </div>
